...
return [
    ...
    */
    ...
    'descriptionpackage'      => 'Попытка сформировать свой проект в интеграции со всеми инструментами',
    'createdby'               => 'Created by',
    'seecode'                 => 'See code at',
    'online'                  => 'Online',
    'home'                    => 'Домой',
    'header'                  => 'Заголовок',
    'anotherlink'             => 'Другой Link',
    ...
    'landingdescriptionpratt' => 'Сайт для личных нужд',
    'description'             => 'Описание',
    'showcase'                => 'Showcase',
    'contact'                 => 'Контакт',
    'laravelpackage'          => 'используется для построения',
    'to'                      => 'to',
